...
print_heading_message "Import a local database backup file (.backup.sql) in local."
...
echo "******************************************************"
echo "1) Importing the .backup.sql to database..."
local_import_database_backup "${LOCAL_WP_PATH}" "${LOCAL_WP_DB_BACKUP}"
echo "******************************************************"
