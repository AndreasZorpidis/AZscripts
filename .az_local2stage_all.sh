...
print_heading_message "Migrate the local files and database into staging."
...
echo "******************************************************"
# Delete existing files on the staging server (except wp-config.php)
echo "4) Cleaning the staging server..."
...
echo "******************************************************"
# Transfer the compressed files and database to the staging server
echo "5) Transferring the files and database to the staging server..."
...
echo "6) Extracting the files to the staging server..."
